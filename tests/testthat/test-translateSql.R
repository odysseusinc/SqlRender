...
test_that("translateSQL sql server -> Oracle functional index", {
    sql <- translateSql("CREATE INDEX name1 ON someTable (firstColumn,secondColumn) WHERE someCondition;", targetDialect = "oracle")$sql
