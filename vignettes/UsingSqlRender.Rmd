...
A second limitation is that currently only these dialects are supported as targets: **Oracle**, **PostgreSQL**, **Microsoft PDW (Parallel Data Warehouse)**, **Impala**, **Netezza**, **Google BigQuery**, **Amazon Redhift**, **Snowflake**, **Apache Spark** and **SQLite**.
...
- The column list does not need to be in the correct order as the destination table, provided the parenthetical column list explicitly states the column names you're targetting.
